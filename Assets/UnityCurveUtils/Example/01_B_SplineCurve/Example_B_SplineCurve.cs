...
namespace UnityCurveUtils_Example
{
	...
	/// ベジェ曲線のサンプル
	/// </summary>
	internal class Example_B_SplineCurve : MonoBehaviour
	{
		...
		private void Update()
		{
			var positions = Enumerable
				.Range( 0, 500 )
				.Select( c => UnityCurveUtils.B_SplineCurve( m_x1, m_y1, m_x2, m_y2, m_x3, m_y3, c / 500f ) )
		...
		private void OnGUI()
		{
			...
			m_x2 = ExampleUtils.PosField( "制御点 の X 座標", m_x2 );
			m_y2 = ExampleUtils.PosField( "制御点 の Y 座標", m_y2 );
			m_x3 = ExampleUtils.PosField( "終点の X 座標", m_x3 );
			m_y3 = ExampleUtils.PosField( "終点の Y 座標", m_y3 );
		}
	}
}